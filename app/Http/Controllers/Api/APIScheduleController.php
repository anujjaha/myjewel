...
class APIScheduleController extends BaseApiController
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        {
            $itemsOutput = $this->scheduleTransformer->scheduleList($items);
    ...
    public function create(Request $request)
    {
        ...
        if($model)
        {
            $responseData = $this->scheduleTransformer->transform($model);

            return $this->successResponse($responseData, 'Schedule is Created Successfully');
        }
    ...
    public function show(Request $request)
    {
        ...
        if($itemId)
        {
            ...
            if($itemData)
            {
                $responseData = $this->scheduleTransformer->transform($itemData);
    ...
    public function edit(Request $request)
    {
        ...
        if($itemId)
        {
            ...
            if($status)
            {
                ...
                return $this->successResponse($responseData, 'Schedule is Edited Successfully');
            }
        }
