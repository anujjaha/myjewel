<?php namespace App\Models\LoginBanner\Traits\Attribute;
...
trait Attribute
{
	...
	{
		return '<a href="'.route($prefix .'.'. $routes->editRoute, $this).'" class="btn btn-xs btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="View"></i></a>';
	}
	 ...
	 * @return string
	 */
	public function getAdminEditButtonsAttribute()
	{
		$repository = new EloquentLoginBannerRepository;
